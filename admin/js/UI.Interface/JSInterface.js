...
var PWACJSInterface = (function() {
  var objects_arr = new Array();

  return {
    localpath: '', // domain path

    AjaxUpload: new PWACAjaxUpload(), // object that makes the upload of a form without refreshin via AJAX
    Preloader: new PWACPreloader(), // the preloader object used for sending data to server through AJAX
    Loader: new PWACLoader(), // the object used to display AJAX error messages

    /*****************************************************************************************/
    /*                                      INIT INTERFACE                                   */
    /*****************************************************************************************/
    /**
		 * initialize the PWACJSInterface
		 * method type: LOCAL
		 * params: none
		 */
    init: function() {
      ...
      jQuery(document).ready(function() {
        PWACJSInterface.Loader.init();
        PWACJSInterface.initObjects();
      });
    },
    ...
    /*****************************************************************************************/
    /**
		 * initialize the PWACJSInterface objects
		 * method type: LOCAL
		 * params: none
		 */
    ...
    /*****************************************************************************************/
    /**
		 * add an object to the PWACJSInterface
		 * method type: LOCAL
		 * params: @objName : the name of the object in the PWACJSInterface
      ...
      if (objTop < scrollTop) {
        ...
        if (objBottom > containerHeight + scrollTop) {
          jQuery(container).animate(
            { scrollTop: objBottom - containerHeight },
            1000
          );
        }
